...
```{r}
  data |>
  ggplot(aes(year)) +
  geom_col(aes(y=assault_number,fill=assault_type),position=position_dodge(1)) +
  theme(
...
```{r}
  data |>
  ggplot(aes(year)) +
  geom_col(aes(y=sexual_assault_number,fill=sexual_assault_type),position=position_dodge(1)) +
  theme(
    legend.position="bottom"
  ) +
  scale_x_continuous(breaks=seq(2006,2020,1)) +
...
```{r}
  data |>
    ggplot(aes(year)) +
    geom_col(aes(y=impaired_operation_number,color=impaired_operation_type,fill=impaired_operation_type),position=position_dodge(1)) +
  theme(
    legend.position="bottom"
  ) +
  scale_x_continuous(breaks=seq(2006,2020,1)) +

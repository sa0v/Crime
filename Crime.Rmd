...
```{r}
  ...
  mutate(sexual_assault_type = case_when(
    ...
    sexual_assault_type == "sexual_assault_level_2_with_a_weapon_or_bodily_harm" ~ "Level 2 (With a Weapon or Bodily Harm)",
...
```{r}
  data |>
    ...
    scale_x_continuous(breaks=seq(2006,2020,1)) +
    labs(
      title="Total Sexual Violations Against Children by Type",
      subtitle="Newfoundland and Labrador",
      x = "Year",
      y = "Violations",
      caption="Data from Open Data Newfoundland and Labrador",
...
## What about trend in motor vehicle thefts over time for the province?
...
```{r}
  data |>
    ...
    ggplot(aes(year,theft_5_000_or_under_from_a_motor_vehicle)) +
    geom_line() +
    geom_smooth(se=FALSE,method="lm") +
    scale_x_continuous(breaks=seq(2006,2020,1)) +
    labs(
...
```{r}
  data |>
    ...
    ggplot(aes(year,theft_over_5_000_from_a_motor_vehicle)) +
    geom_line() +
    geom_smooth(se=FALSE,method="lm") +
    scale_x_continuous(breaks=seq(2006,2020,1)) +
    labs(
...
```{r}
  data |>
    ...
    scale_x_continuous(breaks=seq(2006,2020,1)) +
    labs(
      title="Total sImpaired Operation Causing Bodily Harm and Death",
      subtitle="Newfoundland and Labrador",
      x = "Year",
      y = "Charges",
      caption="Data from Open Data Newfoundland and Labrador",

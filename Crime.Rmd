...
```{r}
  ...
  mutate(assault_level=case_when(
    assault_level =="assault_level_1" ~ "Level 1",
    assault_level == "assault_level_2_with_weapon_or_causing_bodily_harm" ~ "Level 2",
    assault_level == "assault_level_3_aggravated" ~ "Level 3"
  )) |>
  ggplot(aes(year)) +
  geom_col(aes(y=assault_number,fill=assault_level),position="dodge") +
  theme(
...
```{r}
  ...
  mutate(assault_level=case_when(
    assault_level =="sexual_assault_level_1" ~ "Level 1",
    assault_level == "sexual_assault_level_2_with_a_weapon_or_bodily_harm" ~ "Level 2",
    assault_level == "sexual_assault_level_3_aggravated" ~ "Level 3"
  )) |>
  ggplot(aes(year)) +
  geom_col(aes(y=assault_number,fill=assault_level),position="dodge") +
  theme(
...
```{r}
  ...
  pivot_longer(
    ...
    names_to="motor_vehicle_theft_level",
    values_to="motor_vehicle_theft_amount",
  ) |>
  ggplot(aes(year)) +
  geom_col(aes(y=motor_vehicle_theft_amount,fill=motor_vehicle_theft_level),position="dodge") +
  theme(
    legend.position="bottom"
  ) +
  guides(
...
```{r}
  ...
  ggplot(aes(year)) +
  geom_col(aes(y=impaired_operation_number,fill=impaired_operation_type),position="dodge") +
  theme(
    legend.position="bottom"
  ) +
  guides(

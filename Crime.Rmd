...
```{r}
  data |>
    ...
    geom_line(aes(y=total_other_controlled_drugs_and_substances_act_drugs_trafficking_production_or_distribution,color="Total other drugs and controlled substances")) +
    scale_x_continuous(breaks=seq(2006,2020,1)) +
    labs(
